...
export default function Footer() {
	return (
		<footer className="footer footer-center sd:pt-10 sd:pb-10 xz:pt-10 xz:pb-3 bg-base-200 text-base-content rounded" id='footer'>
			<div className='container mx-auto'>
				...
				<nav>
					<h6 className='mb-1 w-[60vw] font-semibold'>
						Для размещения заказа на товар, вы можете воспользоваться кнопкой "Купить" на нашем сайте или воспользоваться одним из следующих способов:
					</h6>
				...
				<aside className='my-6'>
					<p className=''>
						Закрытое акционерное общество "Мебельный центр"
					</p>
					<p className=''>
						УНП 192000000
					</p>
					<p className='mt-5 text-lg font-semibold uppercase'>
			...
			<iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A2e0abf8b3c09429c691fbf3caf2a24411cee0f3406f442d2a4407eedf1b32589&amp;source=constructor" width="100%" height="400" frameBorder="0"></iframe>
